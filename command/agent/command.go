...
func (c *Command) Synopsis() string {
	return "Runs a command-and-control agent"
}

func (c *Command) Help() string {
	helpText := `
Usage: command-and-control agent [options]

  Starts the command-and-control agent and runs until an interrupt is received.
